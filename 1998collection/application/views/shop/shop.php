    	...
    	<div class="container">
    		<div class="row">
    			...
    			<?php foreach ($mangketqua as $value): ?>
		    			...
		    			<div id="aothun" class="col-sm-12 col-md-6 col-lg-3 ftco-animate d-flex">
                ...
                <?php endforeach ?>
		    			 <!-- <div id="aothun1" class="col-sm-12 col-md-12 col-lg-4 ftco-animate d-flex">
		    				<div class="product d-flex flex-column">
                     ...
                     <div class="panel panel-default">
                         ...
                         <div id="collapseOne" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
                             <div class="panel-body">
                                 <ul>
                                 	<li><a href="#aothun">Sport</a></li>
                                 	<li><a href="#aothun1">Casual</a></li>
